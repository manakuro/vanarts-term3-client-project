<?php 
    ...
    // pagination
    $perPageLimit = $config['reviews']['pagination_per_page_limit'];
    $numberOfRows = $db->count('dt_reviews');
                    ...
                    <div class="row">
                        ...
                        <div class="span-l-12 columns">
                            ...
                            <div class="sec-heading-wrapper">
                                <h3 class="sec-heading">reviews</h3>                  
                            </div>

                        </div>

                    <?php foreach($reviewsData as $index => $val): ?>
                        <?php if ($index % 4 === 0): ?>
                        <?php $class = ($index === 0) ? 'sec-reviews-list-top' : ''; ?>
                        <div class="span-l-12 columns sec-reviews-list <?php echo $class; ?>">

                            <div class="sec-top-img-wrapper social-media-outer">
                                
                                <a href="single.php?reviews_id=<?php echo $val['id']; ?>">
                        ...
                        <div class="span-l-4 columns sec-reviews-list social-media-outer">
                                
                            <a href="single.php?reviews_id=<?php echo $val['id']?>" class="sec-news-link">
                                
                                <img src="<?php echo $val['thumb']; ?>" alt="<?php echo $val['title']; ?>">

                                <div class="sec-reviews-list-headline-wrapper">
                                    
                                    <h5 class="sec-reviews-list-headline"><?php echo $val['title']; ?></h5>

                                    <div class="sec-reviews-list-bottom">

                                        <span class="sec-reviews-list-date">
